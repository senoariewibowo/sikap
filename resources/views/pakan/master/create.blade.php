...
@section('title', 'Tambah Pakan - SIKAP')
@section('page-title', 'Tambah Pakan')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Form Tambah Pakan</h2>
        </div>

        <form action="{{ route('pakan.store') }}" method="POST" class="p-6 space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <x-text-input id="harga_pokok" name="harga_pokok" type="number" step="0.01" class="block mt-1 w-full" :value="old('harga_pokok')" />
